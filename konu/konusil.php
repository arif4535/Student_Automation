...
$id = $_GET['id'];
$hidedata = $pdo->prepare("UPDATE konu SET aktifmi = :aktifmi WHERE id = :id");
$gizle = $hidedata->execute(array("aktifmi" => 0, "id" => $id));
if($gizle) 
{
                                    ...
                                    <tbody>
                                        <?php    
                                            ...
                                            ?>
												...
												<td>	
													<a href="<?php echo $siteUrl; ?>/konu/konusil.php?id=<?php echo $row["s_id"]; ?>">	
