            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Öğrenci Belge Listesi</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Aşağıdan şu an sistemde kayıtlı olan öğrencilerin teslim edeceği belge listesini göreblirsiniz</li>
                        </ol>
                                            ...
                                            ?>
                                                <tr>                                               
													...
													<?php if($yetki == 1) { ?><td>
														...
														<button class="btn btn-danger btn-sm" id="delbutton" ><i class="fa fa-download"></i></button></a>
													</td><?php } ?>																									
                                                </tr>		
                                            <?php } ?>                             
                                     </tbody>
