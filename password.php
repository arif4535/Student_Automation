                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="login.php">Öğrenci Giriş</a>
                                            <a class="nav-link" href="ekle.php">Ekle</a>
                                            <a class="nav-link" href="password.php">ŞifremiUnuttum</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Şifrenizi mi unuttunuz?</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Bilgilerinizi doğru bir şekilde yazınız.</li>
                        </ol>
                            ...
                            <div class="card border-0 rounded-lg">
									...
									<form method="post" action="">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="login.php" style="color:#ffc107;">Return to login</a>
                                                <a class="btn btn-warning" href="login.php">Reset Password</a>
                                            </div>										                                          
                                        </form>
                                    </div>
                                </div>
