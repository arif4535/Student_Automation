                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php    
											$sql = "SELECT * FROM sinformation as kullanici INNER JOIN konu as k ON kullanici.konu = k.id";
											//$sql = "SELECT * FROM `sinformation` WHERE 1"; 
                                            $result = $pdo->query($sql);
                                            while($row = $result->fetch(PDO::FETCH_ASSOC))
                                            {
												if($row["yetki"]==2){ //eger ogretmen değil ise tabloda gösteriyor.
                                            ?>
                                                <tr>
													...
													<td>	
													<a href="<?php echo $siteUrl; ?>/konu/konuatama.php?id=<?php echo $row["s_id"]; ?>">	
                                                    <button class="btn btn-warning btn-sm" id="delbutton"><i class="fa fa-folder-plus"></i></button></a>
													</td>
                                                    <td>	
													<a href="<?php echo $siteUrl; ?>/upload/index.html?id=<?php echo $row["s_id"]; ?>">	
                                                    <button class="btn btn-success btn-sm" id="delbutton"><i class="fa-solid fa-arrow-up-from-bracket"></i></button></a>
													</td>													
                                                </tr>
                                            <?php } } ?>                             
                                     </tbody>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Tüm Hakları Saklıdır &copy; ARİF DEĞİRMENCİ</div>
                        </div>
                    </div>
                </footer>
            </div>
