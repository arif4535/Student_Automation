...
class GVAElement_Logo extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Logo', 'vizeon-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Choose Logo Image', 'vizeon-themer' ),
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'default' => [
					'url' => GAVIAS_VIZEON_PLUGIN_URL . 'elementor/assets/images/logo.png',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'max_width',
			[
				'label' => __( 'Max Width', 'vizeon-themer' ),
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Logo Styling', 'vizeon-themer' ),
